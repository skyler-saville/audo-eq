...
def master_from_paths(
    ...
    request = validate_ingest.ingest_local_mastering_request(target, reference, output, correlation_id=correlation_id)
    return mastering_service.master_file(request, correlation_id=correlation_id, eq_mode=eq_mode, eq_preset=eq_preset)
